...
- [ ] **Dual-Ticket & Emission Curve:** Implement the Activity-Based Logarithmic Decay formula for Treasury minting. Differentiate the pure logic between high-difficulty Mint Tickets (drawing from the Treasury) and low-difficulty Fee Tickets (backed by sender UTXOs).
