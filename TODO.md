...
- [ ] **Quorum Settlement:** Add pure reducer logic for a winning Mint Ticket & Transient Proof of Relay to unlock the Treasury UTXO. The holder of the winning ticket uses it's stake weighted routing to send the ticket & proof to ensure it gets incorporated in the majority holders local ledger.
