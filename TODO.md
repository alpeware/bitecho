...
- [ ] **Transient Proof of Relay:** Update directed messaging to require a locked circuit. Implement the cryptographic signature chaining (`[A -> R1 -> B -> R1 -> A]`) to mathematically validate successful round-trip delivery before a lottery ticket can be claimed.
